...
func (app *Application) SearchUsers(w http.ResponseWriter, r *http.Request) {
	...
	app.buffered_render_page2(w, "tpl/search.tpl", PageGlobalData{Title: "Search", TweetTrove: ret.Feed.TweetTrove, SearchText: ret.SearchText}, ret)
}
...
func (app *Application) Search(w http.ResponseWriter, r *http.Request) {
	...
	if is_htmx(r) && c.CursorPosition == CURSOR_MIDDLE {
		...
		app.buffered_render_page2(w, "tpl/search.tpl", PageGlobalData{Title: "Search", TweetTrove: data.Feed.TweetTrove, SearchText: search_text}, data)
	}
}
